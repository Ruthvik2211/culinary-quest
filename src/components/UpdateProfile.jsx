...
const UpdateProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to profile view after successful update (with a small delay)
      setTimeout(() => {
        navigate('/profile');
      }, 1500);
    } catch (err) {
          ...
          <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex space-x-4">
                <Link 
                  to="/profile"
                  className="flex-1 flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-lg font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                >
                  Cancel
                </Link>
                <button
